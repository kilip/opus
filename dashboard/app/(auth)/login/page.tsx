    ...
    <Card className="border-none shadow-2xl bg-background/60 backdrop-blur-xl">
      <CardHeader className="space-y-4 items-center text-center pb-8">
        ...
        <div className="space-y-1">
          <CardTitle className="text-3xl font-bold tracking-tight">Opus</CardTitle>
        ...
        {DEV_MODE && (
          <div className="space-y-6">
            ...
            <form className="space-y-4">
              ...
              <Button type="button" className="w-full h-12 font-bold text-base shadow-lg shadow-primary/20">
