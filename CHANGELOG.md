...
## [0.2.4](https://github.com/kilip/opus/compare/v0.2.3...v0.2.4) (2026-05-19)
...
* **server:** add embed placeholders to fix CI build failure ([623ce44](https://github.com/kilip/opus/commit/623ce44b26aa8c076f91d5a876b64eb2cb1b3711))
...
* **adr:** align all ADRs with organization domain and UUID v7 standard ([2f7be25](https://github.com/kilip/opus/commit/2f7be25af84d95501ac9368bf93f30f12a8894e7))
* **adr:** finalize UUID v7 and organization domain updates in ADR-011 and ADR-015 ([a16a016](https://github.com/kilip/opus/commit/a16a0160304095f12238f626106be2288019c61c))
...
* align ADRs and GEMINI.md with existing code domains ([64032e2](https://github.com/kilip/opus/commit/64032e26b889a5ad206440a43407c5f57b548ce3))
