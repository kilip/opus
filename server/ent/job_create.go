...
func (_c *JobCreate) SetNillableQueue(v *string) *JobCreate {
	if v != nil {
		_c.SetQueue(*v)
	}
	return _c
...
func (_c *JobCreate) SetProcessAt(v time.Time) *JobCreate {
	_c.mutation.SetProcessAt(v)
	return _c
}

// SetNillableProcessAt sets the "process_at" field if the given value is not nil.
func (_c *JobCreate) SetNillableProcessAt(v *time.Time) *JobCreate {
	if v != nil {
		_c.SetProcessAt(*v)
	}
	return _c
...
func (_c *JobCreate) defaults() {
	...
	if _, ok := _c.mutation.ProcessAt(); !ok {
		v := job.DefaultProcessAt()
		_c.mutation.SetProcessAt(v)
	}
...
func (_c *JobCreate) check() error {
	...
	if _, ok := _c.mutation.ProcessAt(); !ok {
		return &ValidationError{Name: "process_at", err: errors.New(`ent: missing required field "Job.process_at"`)}
	}
	if _, ok := _c.mutation.CreatedAt(); !ok {
...
func (_c *JobCreate) createSpec() (*Job, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.ProcessAt(); ok {
