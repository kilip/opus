...
//
//	mockgen -destination=mocks/logger.go -package=mocks github.com/kilip/opus/server/internal/shared/logger Logger
//
...
import (
	...
	logger "github.com/kilip/opus/server/internal/shared/logger"
...
func (m *MockLogger) DebugCtx(ctx context.Context, msg string, fields ...logger.Field) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, msg}
	for _, a := range fields {
		varargs = append(varargs, a)
...
func (m *MockLogger) ErrorCtx(ctx context.Context, msg string, err error, fields ...logger.Field) {
	m.ctrl.T.Helper()
...
func (m *MockLogger) InfoCtx(ctx context.Context, msg string, fields ...logger.Field) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, msg}
	for _, a := range fields {
		varargs = append(varargs, a)
...
func (m *MockLogger) WarnCtx(ctx context.Context, msg string, fields ...logger.Field) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, msg}
	for _, a := range fields {
		varargs = append(varargs, a)
